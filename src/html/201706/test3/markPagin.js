...
(function($){
	...
	$.fn.markpagin = Pagination;
	$.fn.markpagin.defaults =$  
...
(function($) {
    ...
    $.fn.combo = function(_47, _48) {
        ...
        return this.each(function() {
            ...
            if (_4a) {
                ...
                _4a = $.data(this, "combo", {
                    options: $.extend({},
                    $.fn.combo.defaults, $.fn.combo.parseOptions(this), _47),
                    previousText: ""
                });
    ...
    $.fn.combo.parseOptions = function(_52) {
        var t = $(_52);
        return $.extend({},
        $.fn.textbox.parseOptions(_52), $.parser.parseOptions(_52, ["separator", "panelAlign", {
            panelWidth: "number",
