...
var govEditor=function(elem,options){
	...
	govEditor.prototype.init=function(){
		...
		html+="<div id='goveditor'  class='goveditor'>"+
				...
				"</a></div>" +
				"</div>" +
				"<div  class='goveditor-content' id='goveditor-content' contenteditable='true'> " +
				"" +
				"</div>" +
				"" +
				"</div>";
    ...
    govEditor.prototype.updateTagHtml=function(){
    	...
    	var taghtml="<span  class='tagcls'></span>";
			$(".tagcls").remove();
			that.insertHtml(taghtml,$(that.$editContainer));
    }
...
//		if(isIE){
//			document.getElementById('goveditor-content').onchange=function(e){
//				var taghtml="<span  class='tagcls'></span>";
//				$(".tagcls").remove();
//				that.insertHtml(taghtml,$(this));
//			}
//		}else{
//			document.getElementById('goveditor-content').addEventListener("input",function(e){
//				var taghtml="<span  class='tagcls'></span>";
//				$(".tagcls").remove();
//				that.insertHtml(taghtml,$(this));
//			},false); 
//		}
//		$('body').on('keyup mouseup','.goveditor-content',function(e){
//			console.log('keyup');//chrome
//			$(this).focus();
...
//				that.insertHtml(taghtml,$(this));
//				that.prevKeyup=true;
//				//$('.goveditor-content').trigger('click');
//			}else  if(that.prevKeyup){
////				var taghtml="<span  class='tagcls'></span>";
////				$(".tagcls").remove();
////				that.insertHtml(taghtml,$(this));
////				that.prevKeyup=false;
//			}
////			else if(keyCode>=229){
////				var taghtml="<span  class='tagcls'></span>";
////				$(".tagcls").remove();
...
//		});
		...
		$('body .goveditor-content').on('blur',function(){
			...
			if(that.needFocus==true){
				if(!isIE){
					$(this).focus();
					console.log('当前焦点',document.activeElement.tagName);
					var taghtml="<span  class='tagcls'></span>";
					$(".tagcls").remove();
					that.insertHtml(taghtml,$(this));
...
//		$('body .goveditor-content').on('input',function(){
//			console.log('input');//IE
//			$(this).focus();
//			console.log('text=',$(this).text());
////			that.prevKeyinput=true;
////			var taghtml="<span  class='tagcls'></span>";
////			$(".tagcls").remove();
////			that.insertHtml(taghtml,$(this));
//		});
//		$('body .goveditor-content').bind("propertychange",function(){
//			console.log('propertychange');//IE
//			$(this).focus();
//			console.log('text=',$(this).text());
////			that.prevKeyinput=true;
////			var taghtml="<span  class='tagcls'></span>";
